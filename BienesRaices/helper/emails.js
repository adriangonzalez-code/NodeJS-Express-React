...
const emailRegistro = async (datos) => {
    ...
    await transport.sendMail({
        ...
        text: 'Confirmar tu cuenta en BienesRaices.com',
        html: `
                <p>Hola ${nombre} confirma tu cuenta en BienesRaices.com</p>
                <p>Tu cuenta ya está lista, solo debes confirmarla en siguiente enlace:
...
const emailOlvidePassword = async (datos) => {
    ...
    await transport.sendMail({
        from: 'BienesRaices.com',
        to: email,
        subject: 'Reestablece tu Password BienesRaices.com',
